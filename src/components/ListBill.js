...
export default class ListBill extends Component {
  ...
  render() {
    let swipeBtns = [{
     ...
     const money = formatMoney(this.props.careerText , { symbol: "Rp. ", precision: 0, thousand: ".", decimal: "," });
            ...
            <View style={styles.listItemBox}>
              <View style={styles.leftCol}>
                <View style={styles.avatar}>
                  <Image
                    source={require('../../img/emma/invoiceAktif.png')}
                ...
                <View style={styles.info}>
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center', height: 23}}>
                    <Image
                      source={require('../../img/emma/bulan.png')}
                      style={{width: 20, height: 20}}
                    /> 
                    <Text style={[
