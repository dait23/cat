...
export default class NoNavigationBar extends Component {
  constructor(props) {
    super(props);
  }
                  ...
                  return (
                    ...
                    >
                      <View style={styles.leftButton}>
                        <Image
                          source={require('../../img/fkppi/menu.png')}
